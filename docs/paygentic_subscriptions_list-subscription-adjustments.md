## paygentic subscriptions list-subscription-adjustments
...
```
paygentic subscriptions list-subscription-adjustments [flags]
```

### Examples

```
  paygentic subscriptions list-subscription-adjustments --id <id>
```

### Options

```
  -h, --help            help for list-subscription-adjustments
  -i, --id string       The subscription ID [required]
  -l, --limit string    Number of adjustments to return (default "10")
      --offset string   Number of adjustments to skip (default "0")
```
