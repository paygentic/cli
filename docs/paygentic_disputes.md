...
```
paygentic disputes [flags]
```

### Options

```
  -h, --help   help for disputes
```
...
* [paygentic disputes create](paygentic_disputes_create.md)	 - Create
* [paygentic disputes list](paygentic_disputes_list.md)	 - List
