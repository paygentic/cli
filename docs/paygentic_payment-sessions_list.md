...
```
  -c, --customer-id string       Filter to sessions for this customer: payment-link sessions plus the activation and invoice sessions of the customer's subscriptions.
