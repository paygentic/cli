## paygentic billable-metrics list
...
```
paygentic billable-metrics list [flags]
```

### Examples

```
  paygentic billable-metrics list --merchant-id <id>
```
...
```
  ...
  -p, --product-id string    Filter billable metrics by product ID.
```
