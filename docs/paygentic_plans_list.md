...
```
  ...
  -m, --merchant-id string   Filter plans by merchant organization ID
      --offset int           Number of plans to skip
  -p, --product-id string    Filter plans by product ID
```
