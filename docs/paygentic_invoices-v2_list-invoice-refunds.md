## paygentic invoices-v2 list-invoice-refunds
...
```
paygentic invoices-v2 list-invoice-refunds [flags]
```

### Examples

```
  paygentic invoices-v2 list-invoice-refunds --id <id>
```

### Options

```
  -h, --help        help for list-invoice-refunds
