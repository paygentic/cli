## paygentic billing-schedules replace-schedule-intervals
...
```
paygentic billing-schedules replace-schedule-intervals [flags]
```

### Examples

```
  paygentic billing-schedules replace-schedule-intervals --id <id> --intervals '[]'
```
...
```
  ...
  -h, --help                        help for replace-schedule-intervals
      --id string                   [required]
      --intervals string            [required]
      --order-line-item-id string   When set, scope the wipe to this line's intervals only (per-line cell-edit path)
```
