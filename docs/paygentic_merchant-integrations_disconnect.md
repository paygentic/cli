## paygentic merchant-integrations disconnect
...
```
paygentic merchant-integrations disconnect [flags]
```

### Examples

```
  paygentic merchant-integrations disconnect --id <id>
```
...
```
  ...
  -i, --id string   The unique identifier of the merchant integration [required]
```
