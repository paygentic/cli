...
```
paygentic fees get-price [flags]
```

### Examples

```
  paygentic fees get-price --id <id> --subscription-id <id>
```
...
```
  ...
  -s, --subscription-id string   The unique identifier of the subscription. [required]
```
