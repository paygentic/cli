...
A `User` is an entity granted access to an Organization's resources
...
* [paygentic users get](paygentic_users_get.md)	 - Get
* [paygentic users update](paygentic_users_update.md)	 - Update
