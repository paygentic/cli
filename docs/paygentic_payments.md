...
Create and manage one-off payments
...
* [paygentic payments create](paygentic_payments_create.md)	 - Create Payment
* [paygentic payments get](paygentic_payments_get.md)	 - Get Payment
* [paygentic payments list](paygentic_payments_list.md)	 - List Payments
