...
A `Product` is an offering sold by a `Merchant`
...
* [paygentic products create](paygentic_products_create.md)	 - Create
* [paygentic products get](paygentic_products_get.md)	 - Get
* [paygentic products list](paygentic_products_list.md)	 - List
* [paygentic products update](paygentic_products_update.md)	 - Update
