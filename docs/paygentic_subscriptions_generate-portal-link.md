## paygentic subscriptions generate-portal-link
...
```
paygentic subscriptions generate-portal-link [flags]
```

### Examples

```
  paygentic subscriptions generate-portal-link --id <id>
```
...
```
  ...
  -e, --expires-in string   Token lifetime as an ISO 8601 duration. Defaults to PT10M (10 minutes). Maximum is P7D (7 days). Examples: PT10M, PT1H, P1D, P7D.
  -h, --help                help for generate-portal-link
