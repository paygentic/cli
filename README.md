...
Command-line interface for the *Paygentic* API.
...
<br /><br />
> [!IMPORTANT]
> This CLI is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/paygentic/default). Delete this section before > publishing to a package manager.
