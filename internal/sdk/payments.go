...
// Payments - Create and manage one-off payments. A payment represents a single charge that a merchant wants to collect from a customer.
...
func newPayments(rootSDK *Paygentic, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Payments {
	return &Payments{
		rootSDK:          rootSDK,
...
func (s *Payments) List(ctx context.Context, request *operations.ListPaymentsRequest, opts ...operations.Option) (*operations.ListPaymentsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v0/payments")
	if err != nil {
...
func (s *Payments) Get(ctx context.Context, request operations.GetPaymentRequest, opts ...operations.Option) (*operations.GetPaymentResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v0/payments/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
