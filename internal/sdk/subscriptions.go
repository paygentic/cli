...
func newSubscriptions(rootSDK *Paygentic, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Subscriptions {
...
func (s *Subscriptions) Create(ctx context.Context, request operations.CreateSubscriptionRequest, opts ...operations.Option) (*operations.CreateSubscriptionResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
...
func (s *Subscriptions) UpdateSubscription(ctx context.Context, request operations.UpdateSubscriptionRequest, opts ...operations.Option) (*operations.UpdateSubscriptionResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
...
func (s *Subscriptions) GeneratePortalLink(ctx context.Context, request operations.GeneratePortalLinkRequest, opts ...operations.Option) (*operations.GeneratePortalLinkResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	res := &operations.GeneratePortalLinkResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Subscriptions) Terminate(ctx context.Context, request operations.TerminateSubscriptionRequest, opts ...operations.Option) (*operations.TerminateSubscriptionResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	res := &operations.TerminateSubscriptionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// ReconcileSubscriptionFeatures - Reconcile Features
...
func (s *Subscriptions) ReconcileSubscriptionFeatures(ctx context.Context, request operations.ReconcileSubscriptionFeaturesRequest, opts ...operations.Option) (*operations.ReconcileSubscriptionFeaturesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v0/subscriptions/{id}/reconciliations", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	if err != nil || httpRes == nil {
		...
		_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
		return nil, err
	} else if utils.MatchStatusCodes([]string{"400", "401", "403", "404", "429", "4XX", "500", "503", "5XX"}, httpRes.StatusCode) {
		_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
		if err != nil {
			return nil, err
		} else if _httpRes != nil {
	...
	res := &operations.ReconcileSubscriptionFeaturesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.SubscriptionReconciliation
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.SubscriptionReconciliation = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
// ListSubscriptionAdjustments - List Adjustments
...
func (s *Subscriptions) ListSubscriptionAdjustments(ctx context.Context, request operations.ListSubscriptionAdjustmentsRequest, opts ...operations.Option) (*operations.ListSubscriptionAdjustmentsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v0/subscriptions/{id}/adjustments", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListSubscriptionAdjustmentsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.SubscriptionAdjustmentsResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.SubscriptionAdjustmentsResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *Subscriptions) CreateSubscriptionAdjustment(ctx context.Context, request operations.CreateSubscriptionAdjustmentRequest, opts ...operations.Option) (*operations.CreateSubscriptionAdjustmentResponse, error) {
	...
	res := &operations.CreateSubscriptionAdjustmentResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Subscriptions) DeleteSubscriptionAdjustment(ctx context.Context, request operations.DeleteSubscriptionAdjustmentRequest, opts ...operations.Option) (*operations.DeleteSubscriptionAdjustmentResponse, error) {
	...
	res := &operations.DeleteSubscriptionAdjustmentResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
