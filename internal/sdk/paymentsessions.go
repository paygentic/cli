...
func newPaymentSessions(rootSDK *Paygentic, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PaymentSessions {
...
func (s *PaymentSessions) ListPaymentSessions(ctx context.Context, request *operations.ListPaymentSessionsRequest, opts ...operations.Option) (*operations.ListPaymentSessionsResponse, error) {
	...
	res := &operations.ListPaymentSessionsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.ListPaymentSessionsResponseBody
