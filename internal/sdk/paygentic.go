...
import (
	...
	"github.com/paygentic/cli/internal/sdk/retry"
...
type SDKOption func(*Paygentic)

// WithServerURL allows providing an alternative server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *Paygentic) {
...
func New(opts ...SDKOption) *Paygentic {
	sdk := &Paygentic{
		SDKVersion: "0.0.1",
		sdkConfiguration: config.SDKConfiguration{
