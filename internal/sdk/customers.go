...
func (s *Customers) List(ctx context.Context, request operations.ListCustomersRequest, opts ...operations.Option) (*operations.ListCustomersResponse, error) {
	...
	if err != nil || httpRes == nil {
		...
		return nil, err
	} else if utils.MatchStatusCodes([]string{"400", "403", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
...
// ListCustomerPaymentMethods - List payment methods
// List off-session payment methods saved for this customer.
func (s *Customers) ListCustomerPaymentMethods(ctx context.Context, request operations.ListCustomerPaymentMethodsRequest, opts ...operations.Option) (*operations.ListCustomerPaymentMethodsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v0/customers/{id}/paymentMethods", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListCustomerPaymentMethodsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.ListCustomerPaymentMethodsResponseBody
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
...
func (s *Customers) CreateCustomerPaymentMethod(ctx context.Context, request operations.CreateCustomerPaymentMethodRequest, opts ...operations.Option) (*operations.CreateCustomerPaymentMethodResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	res := &operations.CreateCustomerPaymentMethodResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
