...
func newSalesforce(rootSDK *Paygentic, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Salesforce {
	return &Salesforce{
		rootSDK:          rootSDK,
...
// ListSalesforceAccounts - List Salesforce accounts
// Returns Accounts from the merchant's connected Salesforce org via live proxy SOQL.
func (s *Salesforce) ListSalesforceAccounts(ctx context.Context, request operations.ListSalesforceAccountsRequest, opts ...operations.Option) (*operations.ListSalesforceAccountsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v0/integrations/salesforce/accounts")
	if err != nil {
	...
	res := &operations.ListSalesforceAccountsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.ListSalesforceAccountsResponseBody
