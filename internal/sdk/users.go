...
// Users - A `User` is an entity granted access to an Organization's resources. All operations are performed by users.
type Users struct {
	rootSDK          *Paygentic
...
func newUsers(rootSDK *Paygentic, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Users {
	return &Users{
		rootSDK:          rootSDK,
...
func (s *Users) Get(ctx context.Context, request operations.GetUserRequest, opts ...operations.Option) (*operations.GetUserResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v0/users/{id}", request, nil)
	if err != nil {
