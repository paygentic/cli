...
func (s *SchemasPrice) GetInvoiceDisplayGroup() optionalnullable.OptionalNullable[string] {
	if s == nil {
		return nil
	}
	return s.InvoiceDisplayGroup
}
...
func (s *SchemasPrice) GetRateType() *RateType {
	if s == nil {
		return nil
	}
	return s.RateType
...
func (s *SchemasPrice) GetTax() PriceTax {
	if s == nil {
		return PriceTax{}
	}
	return s.Tax
