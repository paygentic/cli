...
type MeteredEntitlementDetailFeatureType string

const (
	MeteredEntitlementDetailFeatureTypeMetered MeteredEntitlementDetailFeatureType = "metered"
)

func (e MeteredEntitlementDetailFeatureType) ToPointer() *MeteredEntitlementDetailFeatureType {
	return &e
}
func (e *MeteredEntitlementDetailFeatureType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "metered":
		*e = MeteredEntitlementDetailFeatureType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MeteredEntitlementDetailFeatureType: %v", v)
	}
}
...
type MeteredEntitlementDetail struct {
	...
	FeatureType MeteredEntitlementDetailFeatureType `json:"featureType"`
...
func (m *MeteredEntitlementDetail) GetFeatureType() MeteredEntitlementDetailFeatureType {
	if m == nil {
		return MeteredEntitlementDetailFeatureType("")
	}
