...
func (p *PurchaseGrantRequest) GetResetMaxRollover() *float64 {
	if p == nil {
		return nil
	}
	return p.ResetMaxRollover
}

func (p *PurchaseGrantRequest) GetResetMinRollover() *float64 {
	if p == nil {
		return nil
	}
	return p.ResetMinRollover
}
