...
// ListSubscriptionsResponseBody - List of subscriptions
...
func (l ListSubscriptionsResponseBody) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListSubscriptionsResponseBody) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &l, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (l *ListSubscriptionsResponseBody) GetData() []components.Subscription {
	if l == nil {
		return nil
	}
	return l.Data
...
func (l *ListSubscriptionsResponseBody) GetPagination() *components.OffsetPagination {
	if l == nil {
		return nil
	}
	return l.Pagination
