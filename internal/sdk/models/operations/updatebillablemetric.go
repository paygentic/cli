...
func (u UpdateBillableMetricResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateBillableMetricResponse) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &u, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (u *UpdateBillableMetricResponse) GetHTTPMeta() components.HTTPMetadata {
	if u == nil {
...
func (u *UpdateBillableMetricResponse) GetBillableMetric() *components.BillableMetric {
	if u == nil {
		return nil
	}
	return u.BillableMetric
}
