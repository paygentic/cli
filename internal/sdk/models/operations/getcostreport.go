...
type GetCostReportResponse struct {
	...
	CostReportResponse *components.CostReportResponse
}

func (g GetCostReportResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetCostReportResponse) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (g *GetCostReportResponse) GetHTTPMeta() components.HTTPMetadata {
	if g == nil {
...
func (g *GetCostReportResponse) GetCostReportResponse() *components.CostReportResponse {
	if g == nil {
		return nil
	}
	return g.CostReportResponse
}
