...
type GetCostSummaryResponse struct {
	...
	// Usage and cost data
	CostUsageResponse *components.CostUsageResponse
}

func (g GetCostSummaryResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetCostSummaryResponse) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (g *GetCostSummaryResponse) GetHTTPMeta() components.HTTPMetadata {
	if g == nil {
...
func (g *GetCostSummaryResponse) GetCostUsageResponse() *components.CostUsageResponse {
	if g == nil {
		return nil
	}
	return g.CostUsageResponse
}
