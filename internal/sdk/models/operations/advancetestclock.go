...
type AdvanceTestClockResponse struct {
	HTTPMeta components.HTTPMetadata `json:"-"`
	// Test clock updated successfully
	TestClock *components.TestClock
}

func (a AdvanceTestClockResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AdvanceTestClockResponse) UnmarshalJSON(data []byte) error {
...
func (a *AdvanceTestClockResponse) GetHTTPMeta() components.HTTPMetadata {
	if a == nil {
...
func (a *AdvanceTestClockResponse) GetTestClock() *components.TestClock {
	if a == nil {
		return nil
	}
	return a.TestClock
