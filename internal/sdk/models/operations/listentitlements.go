...
func (l ListEntitlementsResponseBody) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListEntitlementsResponseBody) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &l, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (l *ListEntitlementsResponseBody) GetObject() *ListEntitlementsObject {
	if l == nil {
		return nil
	}
	return l.Object
...
func (l *ListEntitlementsResponseBody) GetPagination() components.OffsetPagination {
	if l == nil {
...
type ListEntitlementsResponse struct {
	...
	Object *ListEntitlementsResponseBody
}
...
func (l *ListEntitlementsResponse) GetHTTPMeta() components.HTTPMetadata {
	if l == nil {
...
func (l *ListEntitlementsResponse) GetObject() *ListEntitlementsResponseBody {
	if l == nil {
		return nil
	}
	return l.Object
