...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Short:   "Get",
		Long:    "Get",
		Example: "  paygentic usage-events get --id <id>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.GetUsageEventRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetUsageEventRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.UsageEvents.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
