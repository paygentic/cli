...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Short:   "List",
		Long:    "List",
		Example: "  paygentic prices list",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.ListPricesRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.ListPricesRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Prices.List(cmd.Context(), req, sdkOpts...)
	if err != nil {
