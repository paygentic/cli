...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Short:   "Get",
		Long:    "Get",
		Example: "  paygentic billable-metrics get --id <id>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.GetBillableMetricRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetBillableMetricRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.BillableMetrics.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
