...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Short:   "List",
		Long:    "List",
		Example: "  paygentic billable-metrics list --merchant-id <id>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.ListBillableMetricsRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.ListBillableMetricsRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.BillableMetrics.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
