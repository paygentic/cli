...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Short:   "Update",
		Long:    "Update",
		Example: "  paygentic fees update --id <id>",
		RunE:    runUpdateCmd,
	}
	flagutil.RegisterFlags(cmd, updateCmdMeta)
	if err := flagutil.ValidateMeta[operations.UpdateFeeRequest](updateCmdMeta); err != nil {
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.UpdateFeeRequest](cmd, updateCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.Fees.Update(cmd.Context(), *req, sdkOpts...)
	if err != nil {
